...
def seed_slots():
    ...
    for slot in slots:
        ...
        exists = AvailableSlot.query.filter_by(
...
def seed_faqs():
    ...
    faqs = [
        ...
        (
            ...
            "معمولاً بین ۳ تا ۶ ماه"
        ),
        (
            "ماندگاری ژل چقدر است؟",
            "بسته به نوع ژل بین ۶ تا ۱۸ ماه"
        )
    ]
...
def seed_aftercares():
    ...
    items = [
        ...
        (
            "ژل لب",
            "تا ۲۴ ساعت از ماساژ ناحیه خودداری کنید."
        )
    ]

    for service_name, content in items:

        exists = AfterCare.query.filter_by(
